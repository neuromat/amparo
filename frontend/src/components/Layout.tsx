...
import { Home, BookOpen, Search, Menu, X, ChevronDown, Play, Dumbbell, FileText, MapPin, LogIn, User, Mail } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="border-t pt-8 pb-6">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-muted-foreground">
              <a
                href="https://wa.me/5511992827797"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="mailto:rede.amparo@usp.br"
                className="flex items-center gap-2 text-sm hover:text-primary transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm hover:text-primary transition-colors text-center"
              >
